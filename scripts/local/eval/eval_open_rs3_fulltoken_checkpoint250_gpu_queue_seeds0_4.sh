#!/bin/bash
# Local machine launch helper: queue/idle-check defaults assume this host's GPU
# layout and local merged-checkpoint directory structure.
set -euo pipefail
